...
public:
	...
	void FillCellWithImage(const char *column, int row, CString image_file);
	void FillCellWithImage(const char *column, int row, BYTE *image_data, DWORD image_size);
	...
	void SetPageBreak(const char *column, int row);
};
